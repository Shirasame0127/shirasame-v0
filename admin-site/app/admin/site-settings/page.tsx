...
export default function AdminSettingsPage() {
      ...
      <div ref={setNodeRef as any} style={style} {...attributes} className="space-y-2">
        ...
        <div className="flex gap-3 items-center">
          <div className="w-40 h-24 relative rounded overflow-hidden bg-muted border">
            {
              (() => {
                const resp = responsiveImageForUsage(imageUrl || null, 'header-large')
    ...
    return (
      <div ref={setNodeRef as any} style={style} {...attributes} className="inline-block">
        ...
        >
          {
            (() => {
              const resp = responsiveImageForUsage(imageUrl || null, 'list')
  ...
  const handleSave = async () => {
    ...
    if (avatarFile) {
      // Prefer canonical uploaded KEY. If present, persist it; otherwise upload and persist a new key.
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
              ...
              <div className="max-w-[300px] mt-2">
                <ImageUpload
                  ...
                  onUploadComplete={async (key) => {
                    // ImageUpload now reports the canonical image KEY (not a URL). Persist key-only.
                    if (!key) return
                    try {
            ...
            <div>
                ...
                try {
                  // Clear stored key (do not store full URLs)
