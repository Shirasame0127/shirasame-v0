          ...
          const textShadow = (pin as any).tagTextShadow || `${shadowX}px ${shadowY}px ${shadowBlur}px ${shadowRgba}`
              ...
              return (
                <div key={pin.id}>
                  ...
                  <div className="absolute cursor-pointer hover:scale-125 transition-transform z-20" style={{ left: `${dotXPercent}%`, top: `${dotYPercent}%`, transform: "translate(-50%, -50%)", width: dotSizePx, height: dotSizePx }} onClick={() => product ? onProductClick(product) : undefined}>
                  ...
                  <div className="absolute cursor-pointer hover:scale-105 transition-transform whitespace-nowrap z-30" style={{ left: `${tagXPercent}%`, top: `${tagYPercent}%`, transform: "translate(-50%, -50%)" }} onClick={() => product ? onProductClick(product) : undefined}>
